...
// The main package is special in Go, it's where the excution of the program starts.
package main
...
//in goland, a titlecase funchtion will get exported
...
func validateUUID(v interface{}, k string)(ws []string, error []error) {
	...
	if _,err = uuid.Parse(value); err != nil {
		errors = apprend(error, fmt.Errorf("invalid UUID format"))
	}
