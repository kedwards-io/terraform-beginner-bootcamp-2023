...
# we will mock having a state or database for this development server by setting a global varaiable.  You would never use a global variable in a production server.
$home = {}

# This is a ruby class that includes validations from ActiveRecored.
# This will represend out Home resources as a ruby object.
class Home
  # ActiveModel is par of Ruby on Rails.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  put '/api/u/:user_uuid/homes/:uuid' do
    ...
    home = Home.new
    home.town = $home[:town]
    home.dowmain_name = $home[:domain_name]
    home.name = name
    home.description = description
    home.domain_name = domain_name
    home.content_version = content_version
